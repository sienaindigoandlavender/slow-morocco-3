...
export function AlAndalusContent() {
    ...
    <div className="-mt-16">
      ...
      >
        ...
        <div className="px-8 md:px-[8%] lg:px-[12%] pb-16 pt-32 relative z-10">
          ...
          >
            One continuous cultural bridge from Seville to <span className="underline underline-offset-2 hover:text-[#0a0a0a] transition-colors">Fes</span>. Architecture, music, food, language — four layers of shared DNA.
