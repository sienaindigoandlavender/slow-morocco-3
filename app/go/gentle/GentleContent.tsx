...
// WhatsApp icon inline — no dependency
  ...
  return (
    ...
    >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-4">
                      ...
                      <a
                        ...
                        aria-label={`Ask about ${exp.title} on WhatsApp`}
                      >
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                { n: "1", title: "We talk", body: "WhatsApp, email, or phone. Tell us about you, who you're travelling with, and what matters most." },
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#25D366] text-white px-10 py-4 text-xs tracking-[0.15em] uppercase hover:bg-[#1ebe5d] transition-colors"
              aria-label="Start a WhatsApp conversation about accessible Morocco tours"
            >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] flex items-center justify-center shadow-lg hover:bg-[#20bd5a] transition-colors md:hidden"
